...
import net.bakanne.firstmod.block.custom.PulverizerBlock;
...
public class ModBlocks {
    ...
    public static final Block PULVERIZER_BLOCK = register(
            "pulverizer",
            PulverizerBlock::new,
    ...
    public static void setupItemGroups() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ModItems.CUSTOM_ITEM_GROUP_KEY).register((itemGroup) -> {
            itemGroup.add(ModBlocks.PULVERIZER_BLOCK.asItem());
        });
    }
}
